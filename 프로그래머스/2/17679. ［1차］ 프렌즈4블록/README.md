...
<div class="highlight"><pre class="codehilite"><merlin-component id="merlin-code-summarizer" class="merlin-code-summarizer"></merlin-component><code>TTTANT
RRFACC
RRRFCC
TRRRAA
TTMMMF
